...
export const transferData: TransferData[] = [
  ...
  },
  {
    ...
    key: "moveUp",
    title:
      "preference.clipboard.content_settings.label.operation_button_option.move_up",
  },
  {
    icon: "i-lucide:arrow-down",
    key: "moveDown",
    title:
      "preference.clipboard.content_settings.label.operation_button_option.move_down",
  },
  {
    icon: "i-lucide:trash",
    key: "delete",
